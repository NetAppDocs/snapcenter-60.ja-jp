...
[role="lead"]
SnapCenterは、プラグインアプリケーションおよびストレージシステム上でNetAppテクノロジと統合されます。MongoDB、ORASCPM（Oracleアプリケーション）、SAP ASE、SAP MaxDB、Storageプラグインなど、NetAppでサポートされているプラグインを使用するには、SnapCenterグラフィカルユーザインターフェイスを使用します。
...
NetAppでサポートされるプラグインには、次の利点もあります。
